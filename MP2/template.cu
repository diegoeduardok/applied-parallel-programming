                               ...
                               int numCColumns)
{
  ...
  if (row < numCRows && col < numCColumns)
  {
    ...
    {
        c += A[row*numAColumns+i] * B[i*numBColumns+col];
    }
...
int main(int argc, char **argv)
{
  ...
  size_t size_C = sizeof(float) * numCRows * numCColumns;
  ...
  size_t size_A = sizeof(float) * numARows * numAColumns;
  size_t size_B = sizeof(float) * numBRows * numBColumns;
